...
def run_single_test(model_name, iteration, checkpoint_path, dataset_root, dataset_partition, output_dir, backbone_type, loss_type):
    ...
    for model_name, model_config in config['models'].items():
        ...
        for iteration in model_config['iterations']:
            results = run_single_test(
                ...
                backbone_type=model_config.get('backbone_type', 'conv3d'),
                loss_type=model_config.get('loss_type', 'triplet')
            )
