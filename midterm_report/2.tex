...
\begin{itemize}
    ...
    \item Đạt độ hiệu quả tốt nhất (\textit{SOTA tại thời điểm công bố}) trên các tập dữ liệu dáng đi phổ biến (CASIA-B, OUMVLP, GREW, Gait3D), kèm theo sự cân bằng hợp lý giữa độ phức tạp và độ chính xác của mô hình.
\end{itemize}
